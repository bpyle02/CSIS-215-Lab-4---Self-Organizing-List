...
template <typename E> class MoveToFrontSOL : public SelfOrderedListADT<E>
{
	LList<E>* list;
	int comparisons;
...
public:
	...
	//This function reorders the nodes using the Move to Front Heuristic
	//The Move to Front Heuristic simply moves the record that is
	//accessed to the front of the list
	void reorder(int pos)
	{
		...
		list->moveToStart(); //Moves back to the beginning of the list
